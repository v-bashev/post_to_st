...
public class PoSTParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PoSTGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getModelAccess().getGlobVarsAssignment_0(), "rule__Model__GlobVarsAssignment_0");
			builder.put(grammarAccess.getModelAccess().getProgramsAssignment_1(), "rule__Model__ProgramsAssignment_1");
			builder.put(grammarAccess.getModelAccess().getFbsAssignment_2(), "rule__Model__FbsAssignment_2");
